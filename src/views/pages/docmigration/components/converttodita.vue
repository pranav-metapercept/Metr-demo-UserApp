    ...
    <div>
        <Layout>
            ...
            <div>
                ...
                <b-modal ref="my-modal" hide-footer title="important message" hide-close no-close-on-backdrop
                    no-close-on-esc>
                    <div class="d-block text-center">
                        <h6>
                            "I'm sorry, It seems that the formatting of your Word file is not correct, which may be causing
                            some
                            issues.
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm  btn-block px-4 me-1 mb-3"
