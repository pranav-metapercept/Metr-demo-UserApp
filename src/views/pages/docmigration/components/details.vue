  ...
  <div>
    ...
    >
      <div class="d-block text-center">
        <h6>
          "I'm sorry, It seems that the formatting of your Word file is not
          correct, which may be causing some issues. In order to rectify this,
          you will need to adjust the formatting to ensure that it meets the
          required standards. Once you have made the necessary changes, please
          try again."
        </h6>
      </div>
      <hr />
      <button class="btn btn-primary btn-sm mt-3" @click="hideModal">
        Go Back
      </button>
    </b-modal>
    ...
    <div class="container mt-3">
      <div class="card">
        <div class="card-body mx-4">
          <div v-if="!showUploadScreen && !showConvertScreen">
            <div class="text-left">
              <div class="custom-title">
                Please upload a file for DocMigration<span class="text-danger"
                  >*</span
                >
              </div>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <p class="mt-2 drag-and-drop-text word-break word-wrap">
                      ...
                      <span class="text-primary"> .DOCX </span> the file here.
                    </p>
                    <p class="mt-2 accepted-doc-type" v-if="!fileName">
                      Accepted file format: .DOCX formats only.
                    </p>
                  </div>
                  <div class="row">
                    <div class="">
          ...
          <div class="form-group" v-if="showUploadScreen && !showConvertScreen">
            <div>
              <div class="custom-title text-left">
                Upload .DOCX file<span class="text-danger">*</span>
              </div>
            </div>
            <form @submit.prevent="submitForm" enctype="multipart/form-data">
              <!-- File drop zone -->
              <div class="showConvertbtn">
                ...
                >
                  ...
                  <p v-if="showConvertbtn" class="text-secondary">
                    <span class="mdi mdi-check-circle-outline mr-1"></span>Done
                  </p>
                </div>
                <b-progress
                  variant="secondary"
