...
export default {
    data() {
        return {
            email: "admin@metapercept.in",
            password: "123456",
            submitted: false,
            $v: {} // Add this line to initialize $v
        };
    },
    computed: {
        notification() {
                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            <div class="text-center">
                                                <div>
                                                    <a href="/" class="logo">
                                                        <img src="@/assets/images/metr-logo.svg" height="20" alt="logo" />
                                                    </a>
                                                </div>

                                                <h4 class="font-size-18 mt-4">Welcome Back !</h4>
                                                <p class="text-muted">Sign in to continue to METR.</p>
                                            </div>
