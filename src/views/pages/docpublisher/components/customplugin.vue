      ...
      <div class="card-body">
        <form novalidate @submit.prevent>
          ...
          <div class="form-group">
            ...
            <div>
              ...
              >
                ...
                <option
                  v-for="(data, index) in selectOutputFormat"
                  :key="data.id"
                  :value="index"
                >
                  {{ data.transtype }}
          ...
          <div class="form-group mb-0">
            <div>
              <button
                :disabled="!(typeform.inputPath && typeform.releaseTitle)"
              ...
              <button
                @click="resetform"
                class="btn btn-primary btn-sm m-l-5 ml-1"
              >
                Cancel
              </button>
            </div>
  ...
  methods: {
    ...
    async generateOutputFun(path) {
      ...
      let outputParams = {
        ...
        ditaOtFolder:
          this.ditaOtFolder[this.selectedOutputFormatIndex].ditaOtFolder,
      };
      this.releaseParams = {
        ditaMapFileName: this.typeform.inputPath.split("/").pop(),
        outputFormat:
          this.ditaOtFolder[this.selectedOutputFormatIndex].transtype,
          ...
          this.$store.getters.client
            ...
            .then((res) => {
              ...
              setTimeout(() => {
                ...
                this.messageToast("Success", "success", res.data.message);
