    ...
    <div>
        ...
        <div class="col-lg-12 col-xl-6">
            <div class="d-flex flex-wrap justify-content-center">
                ...
                <div class="text-dark h6 my-3" v-for="(image, index) in imageOptions" :key="index"
                    @click="selectImage(image)">
                    <b-card :img-src="getImagePath(image)" img-alt="Card image"
                        :class="{ 'selected-image': selectedTheme === image }" class="custom-card">
                        <b-card-text>
                            <!-- Radio Button for Theme Selection -->
                            <input type="radio" :value="image" v-model="selectedTheme" class="custom-input" />
