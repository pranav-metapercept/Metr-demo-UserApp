  ...
  <div>
    ...
    <div class="form-group row">
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="frontmatter_title_commons.selectedAlignment"
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <input
          ...
          id="color"
          class="form-control"
          v-model="frontmatter_title_commons.color"
        />
      </b-col>
      <b-col sm="6 mt-2 mb-0">
        <label for="font-size">Font-Size</label>
        <multiselect
          v-model="frontmatter_title_commons.fontSize"
    ...
    <div class="form-group row">
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <input
          ...
          id="color"
          class="form-control"
          v-model="topic_title.color"
        />
      </b-col>
      <b-col sm="6 mt-2 mb-0">
        <label for="font-size">Font-Size</label>
        <multiselect
          v-model="topic_title.fontSize"
          :options="topic_title_fontsize.map((item) => item.value)"
        >
        </multiselect>
      </b-col>
