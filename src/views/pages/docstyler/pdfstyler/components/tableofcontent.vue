  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="toc_header.fontSize"
          :options="toc_header_fontsize.map((item) => item.value)"
        >
        </multiselect>
      </b-col>
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="toc_header.fontWeight"
          :options="toc_header_fontweight.map((item) => item.value)"
        >
        </multiselect>
      </b-col>
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="toc_header.spacebefore"
          :options="toc_header_space_before.map((item) => item.value)"
        >
        </multiselect>
      </b-col>
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="toc_header.spaceafter"
          :options="toc_header_space_after.map((item) => item.value)"
        >
        </multiselect>
      </b-col>
    </div>
    ...
    <div class="form-group row">
      ...
      <b-col sm="6 mt-2 mb-0">
        <label for="font-size">Font-Size</label>
        <multiselect
          v-model="toc_chap_content.fontSize"
      ...
      <b-col sm="6 mt-2 mb-0">
        <label for="font-weight">Font-Weight</label>
        <multiselect
          v-model="toc_chap_content.fontWeight"
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <input
          ...
          id="color"
          class="form-control"
          v-model="toc_chap_content.color"
        />
      </b-col>
    </div>
    <!-- Leader Section -->
    ...
    <div class="form-group row">
      ...
      <b-col sm="6 mt-2 mb-0">
        ...
        <multiselect
          v-model="toc_leader.leader"
          :options="toc_leadter_pattern.map((item) => item.name)"
        >
        </multiselect>
      </b-col>
    </div>
