        ...
        <div no-body>
          ...
          <div class="border-top">
            ...
            <div class="categories-group-card">
              ...
              >
                <i
                  class="mdi mdi-format-list-bulleted font-size-18 align-middle mr-2"
                ></i>
                Table of content
              </a>
            </div>
            ...
            <div class="categories-group-card">
              ...
              >
                <i
                  class="mdi mdi-page-layout-header-footer font-size-18 align-middle mr-2"
                ></i>
                Header/Footer
              </a>
            </div>
            ...
            <div class="categories-group-card">
              <a
                class="categories-group-list card-title"
                :class="{
                  active: currentFormNumber === 4,
                  '': currentFormNumber === 4,
                }"
                @click="changeForm(4)"
              >
                <i
                  class="mdi mdi-folder-multiple-outline font-size-18 align-middle mr-2"
                ></i>
                Commons
              </a>
            </div>
            ...
            <div class="categories-group-card">
              <a
                class="categories-group-list card-title"
                :class="{
                  active: currentFormNumber === 5,
                  '': currentFormNumber === 5,
                }"
                @click="changeForm(5)"
              >
                <i
                  class="mdi mdi-table-large font-size-18 align-middle mr-2"
                ></i>
                Tables
              </a>
            </div>
    ...
    finalSubmit() {
      ...
      setTimeout(() => {
        this.messageToast(
          "Success",
          "success",
          `Changes made successfully. Click "Transform" to publish the output.  `
        );
      }, 1000);
      setTimeout(() => {
