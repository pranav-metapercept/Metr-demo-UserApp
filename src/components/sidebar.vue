      ...
      <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
          <template v-for="item in menuItems">
            ...
            <!--end Layouts menu -->
            <li v-if="!item.isTitle && !item.isLayout && !item.hide" :key="item.id">
              <a ref="linkclsref" v-if="hasItems(item)" href="javascript:void(0);" class="is-parent" :class="{
              ...
              <router-link :to="item.link" v-if="!hasItems(item)" class="side-nav-link-ref">
                <div class="icon-cust-class" :class="{ ' custom-class': isActive(item.label) }">
                  <i :class="['bx', item.icon, { 'custom-class': isActive(item.label) }]" v-if="item.icon"></i>
                </div>
                <span v-on:click="setActive(item.label)" :class="{
                  'custom-class': isActive(item.label),
